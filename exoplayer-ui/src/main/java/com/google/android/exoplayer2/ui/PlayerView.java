...
public class PlayerView extends FrameLayout {
    ...
    public void setOnControlChangedListener(OnControlChangedListener onControlChangedListener) {
        if (controller != null) {
            controller.setOnControlChangedListener(onControlChangedListener);
        }
    }
    ...
    private boolean hideControllerEx = false;

    public void setHideControllerEx(boolean hideControllerEx) {
        this.hideControllerEx = hideControllerEx;
    }

    public boolean isHideControllerEx() {
        return hideControllerEx;
    }
    ...
    public interface OnControlChangedListener {
        void onControlChanged(PlayerControlView controller, boolean isShowing);
    }
}

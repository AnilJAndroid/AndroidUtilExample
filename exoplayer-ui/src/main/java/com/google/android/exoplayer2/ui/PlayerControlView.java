...
public class PlayerControlView extends FrameLayout {
  ...
  private PlayerView.OnControlChangedListener onControlChangedListener;

  public void setOnControlChangedListener(PlayerView.OnControlChangedListener onControlChangedListener) {
  ...
  public void show() {
    ...
    if (onControlChangedListener != null) {
      onControlChangedListener.onControlChanged(this, true);
    }
  }
  ...
  public void hide() {
    if (isVisible()) {
      ...
      if (onControlChangedListener != null) {
        onControlChangedListener.onControlChanged(this, false);
      }
    }
  }
  ...
  public View getPlayButton() {
    return findViewById(R.id.exo_play1);
  }
  ...
  public final class ComponentListener extends Player.DefaultEventListener
  ...
  public ImageView getRepeatToggleButton() {
    return repeatToggleButton;
  }

  public View getPauseButton() {
    return findViewById(R.id.exo_pause2);
  }
